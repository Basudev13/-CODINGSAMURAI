...
public class studentgradeCalculator {
    public static void main(String[] args) {
        ...
        double finalGrade = calculateFinalGrade(assignment1, assignment2, midterm, finalExam);
    ...
    public static double calculateFinalGrade(double assignment1, double assignment2, double midterm, double finalExam) {
        ...
        double weightedAverage = ((assignment1 * assignmentWeight) + (assignment2 * assignmentWeight)+
